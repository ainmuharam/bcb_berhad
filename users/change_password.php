<?php
include_once 'user_session.php'; // This should start session and restrict unauthorized access

include '../admin/register_handling.php'; // Assuming it has Database and User classes

$db = new Database(); 
$user = new User($db);

$employeeId = $_SESSION['user_session']['emp_id'] ?? null;
