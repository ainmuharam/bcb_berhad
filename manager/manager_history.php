...
include '../users/users_handling.php';

$managerId = $_SESSION['manager_session']['emp_id'];

if (!isset($_GET['emp_id']) || $_GET['emp_id'] != $managerId) {
...
// Proceed with attendance history for the manager
$database = new Database();
$conn = $database->conn;
$attendance = new userAttendance($conn, $managerId);
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a class="active" href="user_history.php">History</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="order">
                ...
                <tbody>
                    <?php if (!empty($loginHistory)) : ?>
                        ...
                        <?php endforeach; ?>
                    <?php else : ?>
                        <tr><td colspan="4">No manual login history found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
            </div>
